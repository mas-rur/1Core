  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center">
      ...
      <div className="mb-2 flex items-center gap-2 opacity-80">
        <CoreMark size={26} />
        <span className="font-display text-sm font-semibold text-ivory">1Core</span>
      </div>

      <NotFoundRoute />

      <h1 className="mt-6 font-display text-2xl font-semibold text-ivory sm:text-3xl">No route found for this page</h1>
      <p className="mt-2 max-w-sm text-sm text-ivory-muted">
